...
public class AccountBalanceCtrlTest extends SenarioProvider {
	...
	public void singleExpenseInEUR_ForAccountBalance() {
		...
		AccountBalance anAccountBalance = accountBalanceRepo.findOne(new AccountBalanceKey(super.account, CURRENCY_EUR, CategoryApplyTo.Wallet));
	...
	public void multipleExpensesInEURandJPYandUSD_ForAccountBalance() {
		...
		AccountBalance anAccountBalanceinEUR = accountBalanceRepo.findOne(new AccountBalanceKey(super.account, CURRENCY_EUR, CategoryApplyTo.Wallet));
		...
		AccountBalance anAccountBalanceinJPY = accountBalanceRepo.findOne(new AccountBalanceKey(super.account, CURRENCY_JPY, CategoryApplyTo.Wallet));
		...
		AccountBalance anAccountBalanceinUSD = accountBalanceRepo.findOne(new AccountBalanceKey(super.account, CURRENCY_USD, CategoryApplyTo.Wallet));
